<div class="modal modal-upload-file-two is_hidden">
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="content-action">
				<input type="file" name="" class="is_hidden input_file" multiple="true">
			...
			<div class="img-setting">
				<div class="img-attribut">
					<div class="title">
						<span>Attribut de l'image * (Obligatoire)</span>
					</div>
					<div class="content-input">
				...
				<div class="setting">
					<div class="title">
						<span>Paramètre de l'image</span>
					</div>
					<div class="content-input">
